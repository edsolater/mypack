...
class Color {
  ...
  constructor(value: colorValue) {
    this.parseFromHEX(value) ||
      this.parseFromRGB(value) ||
      this.parseFromHSL(value)
  }
  /**
   * 工具函数——生成函数
   * 返回随机生成的颜色字符串
  ...
  parseFromRGB(value: colorValue) {
    return null
  }
  parseFromHSL(value: colorValue) {}
  parseFromHEX(value: colorValue) {
